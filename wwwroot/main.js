...
async function loadLocalModel(
    ...
    try {
        ...
        // ==================================================
        //
        // The model already exists in APS and has already
        // been translated.
        //
        // Therefore:
        //
        ...
        if (
            ...
            showNotification(
                `Loading <strong>${model.name}</strong>...`
            );


            console.log(
                `Loading preloaded model directly: ${model.name}`
            );
            ...
            console.log(
                `Loaded preloaded model: ${model.name}`
            );
        ...
        // ==================================================
        //
        // If a model does not have a preloaded URN,
        // use the original local-model workflow.
        // ==================================================

        showNotification(
            `Preparing <strong>${model.name}</strong>...`
        );
        ...
        // --------------------------------------------------
        // Wait for translation only for fallback models
        // --------------------------------------------------
        ...
        showNotification(
            `Could not load <strong>${model.name}</strong>.<br>Check the browser console.`
        );
